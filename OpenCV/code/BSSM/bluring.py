...
res1 = cv2.blur(img1, (ksize1, ksize1))             # 3*3 
res2 = cv2.blur(img1, (ksize2, ksize2))             # 5*5 
res3 = cv2.boxFilter(img1, -1, (ksize3, ksize3))    # 7*7    
res4 = cv2.filter2D(img1, -1, kernel)
res5 = cv2.boxFilter(img1, -1, (1, 21))             # blur와 같은 효과를 나타냄
